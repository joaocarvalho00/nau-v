// dhrystone_procs.c — Dhrystone procedures Proc_6..8 and Func_1..3
// Based on the riscv-tests benchmarks/dhrystone/dhrystone.c
...
// Forward declaration (Func_3 is defined later in this translation unit)
